...
\def\totaltime{2 hours and 30 minutes\ } %ANSWER TIME + UPLOAD TIME
\def\answertime{2 hours\ } % 1.5 MINUTES PER MARK
...
\ptsmk{5}
	...
	\begin{enumerate}
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		% Each section B question is a separate \item. Use \begin{enumerate}...\item...\end{enumerate} for sub parts.
		% Use \pts{xx} for the number of marks for each sub-part and \ptsmk{xxx} at the end of each question.
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\item Note the right margin should be ragged and not justified
		\begin{enumerate}
			...
			\item Top level parts (e.g. a, b c etc) have a number of marks associated with them give in [ ]. Secondary level parts (i.e. ii, iii etc) do not. % Use the LaTeX commands \pts{x} for doing this!
			\item The overall question (i.e.B2) has the total number of marks in [ ] with the word ``marks''. % Use \ptsmk{x} for this ! 
